    ...
    <nav className="py-10">
      <Container>
        <div className="flex items-center">
          ...
          <div className={`lg:w-7/12 fixed w-full h-full bg-gradient-to-b lg:bg-none lg:static lg:h-auto lg:p-0 from-gray-600 to-gray-900 top-0 p-10 transition-all ${offCanvas ? 'left-0' : '-left-full'} `}>
          ...
          <div className={`lg:w-3/12 w-full absolute left-0 px-10 lg:static lg:px-0 transition-all ${search ? 'top-10' : '-top-40' }`}>
            <button 
